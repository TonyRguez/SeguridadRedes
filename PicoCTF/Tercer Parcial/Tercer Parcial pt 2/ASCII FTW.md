...
# Solución
```
Abrimos el archivo en Ghidra, buscamos la parte del código donde dice "The flag starts with", entonces encontramos lo siguiente
...
Filtramos para quedarnos solo con la última columna, con cyberchef decodificamos de hexa a texto y obtenemos la bandera
```
# Notas
- picoCTF{ASCII_IS_EASY_8960F0AF}
# Referencia
- https://sydneyharris.com/blog/f/picogym-exclusive-ascii-ftw