...
```
# Notas
- Descargamos el archivo, usamos Strings y al final vemos caracteres entre corchetes parecidos a las banderas, agregamos al inicio picoCTF y obtenemos la bandera.
# Referencia